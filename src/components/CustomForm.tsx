  ...
  return (
    <>
      <h1 className="text-3xl sm:text-6xl font-bold text-center">
        {thing ? thing : `What is your "One Thing"?`}
      </h1>
      <form
        className="flex ring-4 rounded-md ring-slate-200 dark:ring-slate-800
      ...
      >
        ...
        <button
          ...
          py-2 pr-6 focus:outline-none focus:text-teal-600 hover:text-teal-600"
        >
